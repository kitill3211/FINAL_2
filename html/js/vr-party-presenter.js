...
var modelsURN=['dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDE4LTAyLTI1LTEyLTAzLTUyLWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlL3NrZWxldG9uLm1heA', 'dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDE4LTAyLTI1LTEyLTAzLTUyLWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlL3NrZWxldG9uLm1heA=','dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDE4LTAyLTI1LTEyLTAzLTUyLWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlL3NrZWxldG9uLm1heA=='];
var _default_models = {
    'pumpkin'       : 'dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDE4LTAyLTI1LTEyLTAzLTUyLWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlL3NrZWxldG9uLm1heA',
    'robot arm'     : 'dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDE4LTAyLTI1LTEyLTAzLTUyLWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlL3NrZWxldG9uLm1heA=',
    'welding robot' : 'dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDE4LTAyLTI1LTEyLTAzLTUyLWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlL3NrZWxldG9uLm1heA==',
    'ergon chair'   : 'dXJuOmFkc2sub2JqZWN0czpvcy5vYmplY3Q6bW9kZWwyMDE4LTAyLTIyLTE2LTI4LTA1LWQ0MWQ4Y2Q5OGYwMGIyMDRlOTgwMDk5OGVjZjg0MjdlL1JvYm90QXJtLmR3Zng==',
...
var _hosts = [ 'lit-garden-89710.herokuapp.com' ];
...
{
    //i - получаем из html, дальше берем из массиваmodelsURN i-ый urn и грузим в Viewer. таки дела, хлопцы
    launchUrn(modelsURN[i]); 
}
function initialize() {
    ...
    if (_sessionId) {        
        ...
        if (_hosts.indexOf(window.location.hostname) > -1) {
            ...
            var urlVR = base_url + '/participant.html?session=' + _sessionId;
            $('#urlVR').attr('href', urlVR);
            $('#qrcodeVR').qrcode(urlVR);
            $('#join').text(base_url+"/join?id=" + _sessionId);
//        
//        var buttonD = document.createElement('div');
//        buttonD.classList.add('cmd-btn-small');
//
//        buttonD.innerHTML = '3D';
//        buttonD.onclick = giveQr();
//
//        panel.appendChild(buttonD);
